...
MOTTS_LOX_MAKE_TEST_CASE(
    assignment_infix_operator_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    assignment_prefix_operator_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    ...
    "call/string.lox",
    "",
    "[Line 1] Error at \"\"str\"\": Can only call functions and classes.\n",
    1
);
...
MOTTS_LOX_MAKE_TEST_CASE(
    constructor_call_init_explicitly_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    constructor_default_arguments_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    ...
    "",
    "[Line 5] Error at \"Foo\": Expected 2 arguments but got 1.\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(
    constructor_return_in_nested_function_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    field_get_on_class_test,
    "field/get_on_class.lox",
    "",
    "[Line 2] Error at \"bar\": Only instances have fields.\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(
    field_get_on_function_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    ...
    "",
    "[Line 3] Error at \"123\": Expected LEFT_BRACE.\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(function_empty_body_test, "function/empty_body.lox", "nil\n", "", 0);
MOTTS_LOX_MAKE_TEST_CASE(
    function_extra_arguments_test,
    "function/extra_arguments.lox",
    "",
    "[Line 6] Error at \"f\": Expected 2 arguments but got 4.\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(
    function_local_mutual_recursion_test,
    "function/local_mutual_recursion.lox",
    "",
    "[Line 4] Error: Undefined variable \"isOdd\".\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(function_local_recursion_test, "function/local_recursion.lox", "21\n", "", 0);
MOTTS_LOX_MAKE_TEST_CASE(
    function_missing_arguments_test,
    "function/missing_arguments.lox",
    "",
    "[Line 3] Error at \"f\": Expected 2 arguments but got 1.\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(
    function_missing_comma_in_parameters_test,
    "function/missing_comma_in_parameters.lox",
    "",
    "[Line 3] Error at \"c\": Expected RIGHT_PAREN.\n",
    1
);
...
MOTTS_LOX_MAKE_TEST_CASE(
    ...
    "",
    "[Line 3] Error at \"foo\": Superclass must be a class.\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(
    inheritance_inherit_from_nil_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    inheritance_inherit_from_number_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    inheritance_parenthesized_superclass_test,
    "inheritance/parenthesized_superclass.lox",
    "",
    "[Line 4] Error at \"(\": Expected IDENTIFIER.\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(
    inheritance_set_fields_from_base_class_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    method_extra_arguments_test,
    "method/extra_arguments.lox",
    "",
    "[Line 8] Error at \"method\": Expected 2 arguments but got 4.\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(
    method_missing_arguments_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    number_decimal_point_at_eof_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    operator_divide_nonnum_num_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    operator_divide_num_nonnum_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    operator_greater_nonnum_num_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    operator_greater_num_nonnum_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    operator_greater_or_equal_nonnum_num_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    operator_greater_or_equal_num_nonnum_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    operator_less_or_equal_nonnum_num_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    operator_less_or_equal_num_nonnum_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    operator_multiply_nonnum_num_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    operator_multiply_num_nonnum_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    operator_subtract_nonnum_num_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    operator_subtract_num_nonnum_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    string_error_after_multiline_test,
    "string/error_after_multiline.lox",
    "",
    "[Line 7] Error: Undefined variable \"err\".\n",
    1
);
...
MOTTS_LOX_MAKE_TEST_CASE(
    ...
    "",
    "[Line 9] Error at \"super\": Expected 2 arguments but got 1.\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(
    super_no_superclass_bind_test,
    "super/no_superclass_bind.lox",
    "",
    "[Line 3] Error: Undefined variable \"super\".\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(
    super_no_superclass_call_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    super_no_superclass_method_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    ...
    "",
    "[Line 5] Error at \";\": Expected IDENTIFIER.\n",
    1
);
...
MOTTS_LOX_MAKE_TEST_CASE(
    this_this_in_top_level_function_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    variable_collide_with_parameter_test,
    "variable/collide_with_parameter.lox",
    "",
    "[Line 2] Error at \"a\": Identifier with this name already declared in this scope.\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(
    variable_duplicate_local_test,
    "variable/duplicate_local.lox",
    "",
    "[Line 3] Error at \"a\": Identifier with this name already declared in this scope.\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(
    variable_duplicate_parameter_test,
    "variable/duplicate_parameter.lox",
    "",
    "[Line 2] Error at \"arg\": Identifier with this name already declared in this scope.\n",
    1
);
...
MOTTS_LOX_MAKE_TEST_CASE(
    variable_scope_reuse_in_different_blocks_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    variable_undefined_global_test,
    "variable/undefined_global.lox",
    "",
    "[Line 1] Error: Undefined variable \"notDefined\".\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(
    variable_undefined_local_test,
    "variable/undefined_local.lox",
    "",
    "[Line 2] Error: Undefined variable \"notDefined\".\n",
    1
);
...
MOTTS_LOX_MAKE_TEST_CASE(
    variable_use_false_as_var_test,
...
MOTTS_LOX_MAKE_TEST_CASE(
    variable_use_nil_as_var_test,
    "variable/use_nil_as_var.lox",
    "",
    "[Line 2] Error at \"nil\": Expected IDENTIFIER.\n",
    1
);
MOTTS_LOX_MAKE_TEST_CASE(
    variable_use_this_as_var_test,
    "variable/use_this_as_var.lox",
    "",
    "[Line 2] Error at \"this\": Expected IDENTIFIER.\n",
    1
);
